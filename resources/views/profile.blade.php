    ...
    <div class="flex flex-wrap bg-gray-100 w-full h-screen">
        <div class="w-3/12 bg-white rounded p-3 shadow-lg">
            <div class="flex items-center space-x-4 p-2 mb-5">
                ...
                <div>
                    <h4 class="font-semibold text-lg text-gray-700 capitalize font-poppins tracking-wide">{{ session()->get('first_name') }} {{ session()->get('last_name') }}</h4>
            ...
            <ul class="space-y-2 text-sm">
                ...
                <li>
                    <a href="{{ url('/qual') }}" class="flex items-center space-x-3 text-gray-700 p-2 rounded-md font-medium hover:bg-gray-200 focus:bg-gray-200 focus:shadow-outline">
                        <span class="text-gray-600">
                            <svg class="h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li>
                    <a href="{{ url('/status') }}" class="flex items-center space-x-3 text-gray-700 p-2 rounded-md font-medium hover:bg-gray-200 focus:bg-gray-200 focus:shadow-outline">
                        <span class="text-gray-600">
                            <svg class="h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li>
                    <a href="{{ url('/purchases') }}" class="flex items-center space-x-3 text-gray-700 p-2 rounded-md font-medium hover:bg-gray-200 focus:bg-gray-200 focus:shadow-outline">
                        <span class="text-gray-600">
                            <svg class="h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li>
                    <a href="{{ url('/logout') }}" class="flex items-center space-x-3 text-gray-700 p-2 rounded-md font-medium hover:bg-gray-200 focus:bg-gray-200 focus:shadow-outline">
                        <span class="text-gray-600">
                            <svg class="h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="w-9/12">
            ...
            <div class="p-10 text-gray-600 ">
                ...
                <div class="content">
                    ...
                    <button class="mt-5 " >
                        <a class="px-8 py-1 border-blue-500 border text-blue-500 rounded transition duration-300 hover:bg-blue-700 hover:text-white focus:outline-none" href="{{ url('editprofile') }}">Edit</a>
                    </button>
                </div>
            </div>
            ...
            <div class="leading-loose mt-2">
                <form class="max-w-xl m-4 p-10 bg-white rounded shadow-xl" method="post" enctype="multipart/form-data">
                    ...
                    <div class="inline-block mt-2 w-1/2 pr-1">
                        ...
                        <input class="w-full px-2 py-2 text-gray-700 bg-gray-200 rounded" name="first_name" type="text" value="{{ $data->first_name }}">
                    ...
                    <div class="inline-block mt-2 -mx-1 pl-1 w-1/2">
                        ...
                        <input class="w-full px-2 py-2 text-gray-700 bg-gray-200 rounded" name="last_name" type="text" value="{{ $data->last_name }}">
                    ...
                    <div class="inline-block mt-2 w-1/2 pr-1">
                        ...
                        <input class="w-full px-2 py-2 text-gray-700 bg-gray-200 rounded" name="username" type="text" value="{{ $data->username }}">
                    ...
                    <div class="inline-block mt-2 -mx-1 pl-1 w-1/2">
                        ...
                        <input class="w-full px-2 py-2 text-gray-700 bg-gray-200 rounded" name="phone_number" type="text" value="{{ $data->phone_number }}">
                        @error('dob')<span class="text-red-500 text-sm">{{ 'The Date of birth field is required.' }}</span>@enderror
                    </div>
                    <div class="mt-2">
                        <label class="block text-sm text-gray-600" for="cus_email">Email</label>
                        <input class="w-full px-2 py-2 text-gray-700 bg-gray-200 rounded" name="email" type="email" value="{{ $data->email }}">
                        @error('email')<span class="text-red-500 text-sm">{{ 'The Email field is required.' }}</span>@enderror
                    </div>                    
                    <div class="mt-2">
                        <label class=" block text-sm text-gray-600" for="cus_email">Address</label>
                        <input class="w-full px-2 py-2 text-gray-700 bg-gray-200 rounded" name="address" type="text" value="{{ $data->address }}">
                    ...
                    <div class="inline-block mt-2 w-1/2 pr-1">
                        ...
                        <input class="w-full px-2 py-2 text-gray-700 bg-gray-200 rounded" name="city" type="text" value="{{ $data->city }}">
                    ...
                    <div class="inline-block mt-2 w-1/2 pr-1">
                        ...
                        <input class="w-full px-2 py-2 text-gray-700 rounded" name="pro_pic" type="file" value="{{ $data->pro_pic }}">
                        {{-- @error('city')<span class="text-red-500 text-sm">{{ 'The City field is required.' }}</span>@enderror --}}
                    </div>

                    <div class="mt-4">
                        <button class="py-3 bg-green-500 text-white w-full rounded hover:bg-green-600" type="submit">Update</button>
                    </div>
                </form>
            </div>
        ...
        <button class="mt-3 ml-3" >
                        <a class="px-8 py-1 border-blue-500 border text-blue-500 rounded transition duration-300 hover:bg-blue-700 hover:text-white focus:outline-none" href="{{ url('addqual') }}">Add Qualification</a>
                    </button>
      </div>
            ...
            <div class="leading-loose mt-2">
                <form class="max-w-xl m-4 p-10 bg-white rounded shadow-xl" method="post">
                    ...
                    <div class="mt-2">
                        ...
                        <input class="w-full px-2 py-2 text-gray-700 bg-gray-200 rounded" name="subject" type="text" Placeholder="Enter Subject">
                        {{-- @error('first_name')<span class="alert alert-danger text-red-500 text-sm">{{ 'The First Name field is required.' }}</span>@enderror --}}
                    </div>
                    <div class="mt-2">
                    ...
                    <div class="inline-block mt-2 -mx-1 pl-1 w-1/2">
                        ...
                        <input class="w-full px-2 py-2 text-gray-700 bg-gray-200 rounded" name="year" type="number" placeholder="Enter Year">
                        @error('dob')<span class="text-red-500 text-sm">{{ 'The Date of birth field is required.' }}</span>@enderror
                    </div>                                     
                    ...
                    <div class="mt-3">
                        <button class="py-3 mb-3 bg-green-500 text-white w-full rounded hover:bg-green-600" type="submit">Add</button>
                        <button class="py-3 bg-red-500 w-full text-white rounded hover:bg-red-600"><a class="py-3 px-20" href="{{ url('/qual') }}">Cancel</a></button>
                    </div>    
                </form>
            </div>
